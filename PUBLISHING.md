...
- [ ] Repository renamed to `greyg-claude-code` ✅
...
2. Fill in the details:
   - **Repository name**: `greyg-claude-code`
...
```bash
cd ~/Documents/GitHub/greyg-claude-code

# Add the GitHub remote
git remote add origin https://github.com/GreyGonz/greyg-claude-code.git
...
/plugin install GreyGonz/greyg-claude-code
...
```bash
/plugin uninstall greyg-claude-code
```

## Step 3: Share Your Plugin

Your README already includes your GitHub username `GreyGonz`, so users can copy-paste commands directly!
...
```json
{
  "name": "greyg-claude-code",
  "source": "GreyGonz/greyg-claude-code",
...
GitHub: https://github.com/GreyGonz/greyg-claude-code
```
...
```bash
/plugin update greyg-claude-code
```
...
1. Go to your repo: https://github.com/GreyGonz/greyg-claude-code
...
```bash
/plugin install GreyGonz/greyg-claude-code@v1.0.0
```
